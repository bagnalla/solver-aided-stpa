...
# some places, and less so in others where Any is used because I
# wasn't sure what the type should be) but are good enough for our
# purposes.
...
class Context():
    ...
    def push(self) -> bool: ...
    def pop(self) -> bool: ...
    def check_context(self, params: Any = None, timeout: Any = None) -> Status: ...
    def dispose(self) -> None: ...

class Model:
    def collect_defined_terms(self) -> List[Term]: ...
    def get_bool_value(self, Term) -> bool: ...
    def get_integer_value(self, Term) -> int: ...
    def get_scalar_value(self, Term) -> int: ...
    @staticmethod
